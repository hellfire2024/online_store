...
router.post('/', async (req, res) => {
    try {
        ...
        await pool.query(`INSERT INTO staff (id, name, role, image_url, created_at)
       VALUES (?, ?, ?, ?, NOW())`, [id, name, role, image_url || null]);
...
router.put('/:id', async (req, res) => {
    try {
        ...
        const [result] = await pool.query(`UPDATE staff SET name = ?, role = ?, image_url = ? WHERE id = ?`, [name, role, image_url || null, req.params.id]);
