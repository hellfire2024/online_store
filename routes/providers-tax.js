 ...
 */
router.post("/taxjar", async (req, res) => {
    try {
 ...
 */
router.post("/avalara", async (req, res) => {
    try {
        const { cartItems, shippingCost, shippingState, shippingZip, accountId, licenseKey, environment, } = req.body;
 ...
 */
router.post("/taxcloud", async (req, res) => {
    try {
        ...
        const subtotal = calculateSubtotal(cartItems);
        const cartItems_ = cartItems.map((item, index) => ({
            Index: index,
 ...
 */
router.post("/zamp", async (req, res) => {
    try {
        const { cartItems, shippingCost, shippingState, shippingZip, apiKey } = req.body;
        if (!apiKey) {
 ...
 */
router.post("/anrok", async (req, res) => {
    try {
        const { cartItems, shippingCost, shippingState, shippingZip, apiKey } = req.body;
        if (!apiKey) {
...
//# sourceMappingURL=providers-tax.js.map