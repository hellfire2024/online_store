...
router.put('/', async (req, res) => {
    try {
        ...
        const [result] = await pool.query(`INSERT INTO site_settings (id, settings) VALUES (1, ?)
       ON DUPLICATE KEY UPDATE settings = ?`, [settingsJson, settingsJson]);
        console.log('Settings saved successfully to database, affected rows:', result.affectedRows);
