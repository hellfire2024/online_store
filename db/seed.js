...
export async function seedDatabase() {
    ...
    try {
        ...
        await pool.query(`INSERT INTO admins (id, username, email, password_hash, role, permissions)
       VALUES (?, ?, ?, ?, ?, ?)
       ...
       ON DUPLICATE KEY UPDATE name = name`, [galleryId, 'Sample Patterns']);
        // Create sample product
        const productId = crypto.randomUUID();
        await pool.query(`INSERT INTO products (id, name, description, price, image_url, inventory, customizable, gallery_id, allow_custom_image_upload, custom_image_upload_price)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
