    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      {customer.orders.length === 0 ? (
        <div className="bg-slate-800 p-6 rounded-lg border border-slate-700 text-center">
          <p className="text-gray-400">No orders yet. Start shopping to place your first order!</p>
        </div>
      ) : (
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-white font-bold">{order.items.length} item{order.items.length !== 1 ? 's' : ''}</p>
                </div>
              </div>
              ...
              {order.trackingNumber && (
                <div className="mb-4">
                  ...
                  <p className="text-sky-400 font-mono">{order.trackingNumber}</p>
                </div>
              )}
              ...
              {selectedOrder?.id === order.id && (
                <div className="mt-6 pt-6 border-t border-slate-700">
                  <div className="mb-4">
                    <h4 className="text-lg font-bold text-white mb-2">Shipping Address</h4>
