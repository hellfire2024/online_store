...
const GalleriesManagement: React.FC = () => {
  ...
  const handleEditImage = async (imageId: string, newName: string) => {
    ...
    try {
      await updateGalleryImage(selectedGalleryId, imageId, {
        name: newName.trim(),
      });
          ...
          <div className="mb-4">
            <div className="flex gap-2 mb-2">
              ...
              <button
                ...
                className="bg-sky-500 text-white p-2 rounded-lg flex items-center justify-center hover:bg-sky-600"
              >
          ...
          {selectedGalleryId ? (
                            ...
                            {editingImageId === image.id ? (
                              ...
                              <>
                                ...
                                <div className="flex gap-1 justify-end">
                                  ...
                                  <button
                                    onClick={() =>
                                      delImg(selectedGalleryId, image.id)
                                    }
            ...
            <div className="flex items-center justify-center h-full">
              <p className="text-gray-400">
                Select a gallery on the left to manage its images, or create a
                new one.
              </p>
            </div>
          )}
