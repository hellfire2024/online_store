...
const CustomerAccountPage: React.FC = () => {
  const { customer, updateProfile, updateEmailPreferences, logout } = useCustomerAuth();
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            {isEditing ? (
              ...
              <p className="mt-1 text-white">{customer.phone || 'Not provided'}</p>
            )}
          </div>

          <div className="pt-4">
            <p className="text-sm text-gray-400">Member since {new Date(customer.createdAt).toLocaleDateString()}</p>
          </div>
      ...
      <div className="bg-slate-800 p-6 rounded-lg border border-slate-700 mb-6">
        ...
        <div className="space-y-4">
          <label className="flex items-center">
            ...
            />
            <span className="ml-3 text-gray-300">Receive marketing emails and promotions</span>
          </label>
          ...
          <label className="flex items-center">
            <input
              ...
              className="rounded text-sky-500"
            />
            <span className="ml-3 text-gray-300">Receive order status updates</span>
          </label>
          ...
          <label className="flex items-center">
            <input
              ...
              className="rounded text-sky-500"
            />
            <span className="ml-3 text-gray-300">Receive announcements and news</span>
          </label>
