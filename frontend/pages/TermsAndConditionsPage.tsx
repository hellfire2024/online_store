            ...
            <div className="prose prose-invert max-w-none text-gray-300">
              <div
                dangerouslySetInnerHTML={{
                  __html: siteSettings.termsAndConditionsContent,
                }}
                className="space-y-4"
              />
            </div>
            ...
            <>
              <section>
                ...
                <p className="text-gray-300">
                  By accessing and using this website and purchasing products
                  from Custom Threads Online Store, you accept and agree to be
              ...
              <section>
                ...
                <p className="text-gray-300 mb-3">
                  ...
                  materials (information or software) on Custom Threads Online
                  Store website for personal, non-commercial transitory viewing
              ...
              <section>
                ...
                <p className="text-gray-300">
                  The materials on Custom Threads Online Store website are
                  provided on an 'as is' basis. Custom Threads makes no
              ...
              <section>
                ...
                <p className="text-gray-300">
                  In no event shall Custom Threads or its suppliers be liable
                  ...
                  Custom Threads Online Store website, even if Custom Threads or
              ...
              <section>
                ...
                <p className="text-gray-300">
                  The materials appearing on Custom Threads Online Store website
                  could include technical, typographical, or photographic
                  errors. Custom Threads does not warrant that any of the
                  materials on the website are accurate, complete, or current.
                  Custom Threads may make changes to the materials contained on
              ...
              <section>
                ...
                <p className="text-gray-300">
                  Custom Threads has not reviewed all of the sites linked to its
                  website and is not responsible for the contents of any such
                  linked site. The inclusion of any link does not imply
                  endorsement by Custom Threads of the site. Use of any such
              ...
              <section>
                ...
                <p className="text-gray-300">
                  Custom Threads may revise these terms of service for its
              ...
              <section>
                ...
                <p className="text-gray-300 mb-3">
                  ...
                  pricing, or other content on our website is accurate,
                  complete, reliable, current, or error-free. If a product
                  offered by Custom Threads is not as described, your sole
              ...
              <section>
                ...
                <p className="text-gray-300">
                  ...
                  5-7 business days. Shipping costs are non-refundable unless
              ...
              <section>
                ...
                <div className="mt-3 p-4 bg-slate-700 rounded-md">
                  ...
                  <p className="text-gray-400 text-sm mt-2">
                    Email: support@customthreads.com
                    <br />
