...
function formatAddressForShipStation(address) {
    return {
...
export async function createLabel(shipmentData, carrierCode, serviceCode) {
    try {
        const labelData = {
        ...
        throw new Error(`Failed to create ShipStation label: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
}
export async function trackShipment(trackingId, carrierCode) {
    try {
...
//# sourceMappingURL=shipstationService.js.map